...
public class MenuFrame extends JFrame {
    ...
    public MenuFrame() {
        ...
        aboutItem.setMnemonic('A'); //configura mnemonico com A
        ...
        exitItem.addActionListener(new ActionListener() //classe interna anonima
        {
            //termina o aplicativo quando o usuario clica em exitItem
            @Override
            public void actionPerformed(ActionEvent event) {
        ...
        fontMenu.setMnemonic('n'); //configura o mnemonico como n
        ...
        StyleHandler styleHandler = new StyleHandler(); //rotina de tratamento de estilos
        ...
        add(displayJLabel, BorderLayout.CENTER); //adiciona diplayJLabel
