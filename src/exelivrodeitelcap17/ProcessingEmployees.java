...
public class ProcessingEmployees {
    ...
    public static void main(String[] args) {
        ...
        //Exibe Employees com salarios no intervalo US$ 400-US$ 6000
        //classificados em ordem crescente por salario
        System.out.printf("%nEmployees eraning $4000-$6000 per month sorted by salary:%n");
        list.stream()
        ...
        //classifica funcionarios em ordem decrescente pelo sobrenome e, então, pelo nome
        ...
        //calcula a media de salarios de Employees com o metodo average DoubleStream
