...
public class JFileChooserDemo extends JFrame {
    ...
    public JFileChooserDemo() throws IOException {
        ...
        analyzePath(); //obtem o Path do usuário e exibe informacoes
    }
    ...
    public void analyzePath() throws IOException {
        ...
        {
            JOptionPane.showMessageDialog(this, path.getFileName() + "dows not exist.", "ERROR", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private Path getFileOrDirectoryPath() {
        //configura dialogo permitindo a selecao de um arquivo ou diretorio
