...
public class FibonacciNumbers extends JFrame{
    ...
    //componentes para calcular o numero de Fibonacci inserido pelo usuário
    ...
    public FibonacciNumbers() {
        ...
        goJButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                ...
                try {
                    ...
                    //exibe uma mensagem de erro se o usuario nao inseriu um numero inteiro
                    fibonacciJLabel.setText("Enter an interger.");
                    return;
                }
                ...
                //cria uma terfa para realizar o calculo em segundo plano
        ...
        ); //fim da chamada para action Listener
