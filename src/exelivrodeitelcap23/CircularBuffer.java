...
public class CircularBuffer implements Buffer {
    ...
    private int occupiedCells = 0; //conta o numero de buffers utilizados
    private int writeIndex = 0; //indice do proximo element oem que gravar
    ...
    public synchronized void blockingPut(int value) throws InterruptedException {
        ...
        //enquanto nao houver posicoes vazias, poe a thread no estado bloqueado
        ...
        //atualiza indice de gravação circular
    ...
    public synchronized int blockingGet() throws InterruptedException {
        ...
        int readValue = buffer[readIndex]; //le valor do buffer
    ...
    public synchronized void displayState(String operation) {
        ...
        for (int i = 0; i < buffer.length; i++) {
            ...
            if (i == writeIndex && i == readIndex) {
                ...
                System.out.print("    "); //nenum dos indices
            }
        }
