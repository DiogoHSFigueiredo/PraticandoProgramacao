...
public class PrimeCalculator extends SwingWorker<Integer, Integer> {
    ...
    //encontra todos os numeros primos ate max usando o Crivo de Eratostenes
    public Integer doInBackground() {
        int count = 0; //o numero de primos encontrados

        //comecando no terceiro valor, circula pelo array e coloca falso como o valor de qualquer numero maior que for um multiplo
    ...
    //codigo para executar quandodoInBackground completa
    protected void done() {
